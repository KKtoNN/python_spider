...
if __name__ == "__main__":
    # main()
    # cmdline.execute("scrapy crawl zjw".split())
    # cmdline.execute("scrapy crawl zjw --nolog".split())
    # Popen("scrapy crawl zjw".split())
    # 直接循环执行
    while True:
        start_time = time.time()
        print("START TIME :{}".format(start_time))
        os.system("scrapy crawl zjw --nolog")
        # os.system("scrapy crawl zjw ")
